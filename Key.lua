--[[
    ================================================================
    [ SCRIPT INFORMATION ]
    Project: DODO-DEVIL Script
    Author: K1ha2
    YouTube: https://www.youtube.com/@K1ha2
...
local Config = {
    ...
    ServiceId       = 31786, -- Your PlatoBoost Service ID
    PlatoSecret     = "8c3ef3ec-2b69-478d-a932-526f20fdcf6f", -- Your PlatoBoost Secret Key

    -- [2] Anti-Bypass / Global Secret Variable
    Secret          = "i-m-devil4you", -- This makes the script ONLY run from the key script. Even if they copy the original obfuscated script to bypass the key, they won't be able to!
    
    -- [3] Scripts & Links
    MainScriptURL   = "https://raw.githubusercontent.com/dodo-devil/DODO-DEVIL/refs/heads/main/script.lua", -- The raw URL of your main script
    ...
    -- [6] GUI Management
    OldGuiName      = "DODO-DEVIL", -- Name of the old GUI to destroy if it's already open
    MainGuiName     = "DODO-DEVIL", -- Name of the main script's GUI to check if it's already executing

    -- [7] Hub Information & UI Text
    HubName         = "DODO-Hub", -- The main title shown at the top of the GUI
    HubDescription  = "SUBCRIBE" -- The text shown below the title
}
